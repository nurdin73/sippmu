...
<head>
    ...
    <title>SIMKATMUH - Aplikasi Pembukuan Akuntansi Keuangan Digital </title>
        ...
        <div class="flex-grow-1">
            <div class="h-20 d-md-flex align-items-center auth-side-img">
                <div class="col-sm-3 auth-content w-auto">
                    <img src="<?php echo base_url(); ?>assets/images/muhammadiyah-logo.jpg" alt="" class="img-fluid logo-muh">
                </div>
            </div>
            <div class="auth-side-form">
                <div class=" auth-content">
                    <div class="xcenter"><img src="<?php echo base_url(); ?>assets/images/logo2.png" alt="" class="img-fluid mb-4" style="height:100px"></div>
                    <h4 class="mb-2 f-w-400">SIMKATMUH SEKOLAH</h4>
