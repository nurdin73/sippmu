                    <ul class="nav pcoded-inner-navbar ">
                        ...
                        if ($this->module_lib->hasActive('sdm')) {
                            if ($this->rbac->hasPrivilege('sdm', 'can_view') ) {
                                ?>
                                <li class="nav-item <?php echo set_Topmenu('sdm'); ?>"><a href="<?php echo base_url(); ?>sdm" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">SDM</span></a></li>
                        ...
                        if ($this->module_lib->hasActive('master_data')) {
                            if ($this->rbac->hasPrivilege('master_cabang', 'can_view') || $this->rbac->hasPrivilege('master_cabang_klasifikasi', 'can_view') || 
                                ...
                                <li class="nav-item pcoded-hasmenu <?php echo set_Topmenu('master_data'); ?>">
                                    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-cpu"></i></span><span class="pcoded-mtext">Master Data</span></a>
                                    <ul class="pcoded-submenu">
                                        <?php
                        ...
                        if ($this->module_lib->hasActive('user_management')) {
                            if (($this->rbac->hasPrivilege('user', 'can_view'))) {
                                ...
                                <li class="nav-item pcoded-hasmenu <?php echo set_Topmenu('HR'); ?>">
                                    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">Manajemen User</span></a>
                                    <ul class="pcoded-submenu">
                                        <?php if ($this->rbac->hasPrivilege('user', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('admin/user'); ?>"><a href="<?php echo base_url(); ?>admin/user"> <?php echo $this->lang->line('user_directory'); ?></a></li>
...
//                                      ?>
                                        ...
                                        <?php if ($is_admin || $is_superadmin) { ?>
                                            <li class="<?php echo set_Submenu('admin/roles'); ?>"><a href="<?php echo base_url(); ?>admin/roles"> <?php echo $this->lang->line('roles_permissions'); ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                <?php
