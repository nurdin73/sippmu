				...
				<div class="">
					<div class="main-menu-header">
						...
						<div class="user-details">
							<div id="more-details"><?php echo $this->config->item('app_name_lite');?> <?php echo strtoupper($this->customlib->getSessionCabangName()); ?> <i class="fa fa-caret-down"></i></div>
						</div>
					</div>
					<div class="collapse" id="nav-user-link">
						<ul class="list-inline">
							<li class="list-inline-item"><a href="<?php echo base_url(); ?>admin/user/profile/<?php echo encrypt_url($id) ?>" data-toggle="tooltip" title="View Profile"><i class="feather icon-user"></i></a></li>
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            ...
                            <ul class="pro-body">
                                <li><a href="<?php echo base_url(); ?>admin/user/profile/<?php echo encrypt_url($id) ?>" class="dropdown-item"><i class="feather icon-user"></i> Profile</a></li>
