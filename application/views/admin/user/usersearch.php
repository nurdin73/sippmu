                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <?php echo $this->session->flashdata('msg') ?> <?php } ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input id="cabang" name="cabang" type="hidden" class="form-control"
                                                    value="<?php echo $cabangx; ?>" />
                                                <select <?php echo $is_disabled; ?> id="cabangx" name="cabangx"
                                                    class="form-control">
                                                    <?php
                                                    if ($is_pusat) {
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $row['id'] ?>" <?php if (isset($cabangxx) && $cabangxx == $row['id']) {
                                                                                                        echo 'selected';
                                                                                                    } ?>>
                                                        <?php echo $row["kode"] ?> - <?php echo $row["nama"] ?></option>
                                                    <?php }
                                                    ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <select name="role" class="form-control">
                                                    ...
                                                    <option <?php
                                                                ...
                                                                ?> value="<?php echo $role_value['type'] ?>">
                                                        <?php echo $role_value['type'] ?></option>
                                                    <?php }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" name="search_text" class="form-control"
                                                    ...
                                                    placeholder="<?php echo $this->lang->line('search_by_user'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="false"><i
                                            class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('card'); ?>
                                        <?php echo $this->lang->line('view'); ?></a></li>
                                <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="true"><i
                                    ...
                                    <table class="table table-striped table-bordered table-hover example"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a <?php if ($this->rbac->hasPrivilege('can_see_other_users_profile', 'can_view')) { ?>
                                                        href="<?php echo base_url(); ?>admin/user/profile/<?php echo encrypt_url($user['id']); ?>"
                                                ...
                                                <td class="pull-right">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>admin/user/profile/<?php echo encrypt_url($user['id']) ?>"
                                                ...
                                                <div class="staffinfo-box">
                                                    <div class="staffleft-box">
                                                        <?php
                                                                    ...
                                                                    ?>
                                                        <img
                                                            src="<?php echo base_url() . "uploads/user_images/" . $image ?>" />
                                                    </div>
                                                    <div class="staffleft-content">
                                                        <h5><span data-toggle="tooltip"
                                                                title="<?php echo $this->lang->line('name'); ?>"
                                                                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $user["name"]; ?></span>
                                                        </h5>
                                                        <p>
                                                            <font data-toggle="tooltip"
                                                                title="<?php echo "Employee Id"; ?>"
                                                                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing">
                                                                <?php echo $user["username"] ?></font>
                                                        </p>
                                                        <p>
                                                            <font data-toggle="tooltip"
                                                                title="<?php echo "Contact Number"; ?>"
                                                                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing">
                                                                <?php echo $user["phone"] ?></font>
                                                        </p>
                                                        <p>
                                                            <font data-toggle="tooltip" title="<?php echo 'Cabang'; ?>"
                                                                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing">
                                                                <?php echo $user["cabang"]; ?></font>
                                                        </p>
                                                        <p class="staffsub"><span data-toggle="tooltip"
                                                                title="<?php echo $this->lang->line('role'); ?>"
                                                                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $user["user_type"] ?></span>
                                                        </p>
                                                    </div>
                                                    <div class="overlay3">
                                                        <div class="stafficons">
                                                            ...
                                                            <?php if ($this->rbac->hasPrivilege('can_see_other_users_profile', 'can_view')) { ?>
                                                            <a title="Show"
                                                                href="<?php echo base_url() . "admin/user/profile/" . encrypt_url($user["id"]); ?>"><i
