                        ...
                        <div class="box-header ptbnull">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_add')) {
                                    ...
                                    <button class="btn btn-primary btn-sm pull-right" onclick="add_task()"><i class="fa fa-plus-square-o"></i></button>
                                <?php } ?>
                            </div>
                    ...
                    <form role="form"  id="addtodo_form" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div id="permission"><?php if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_add')) { ?>
                                    ...
                                    <input type="submit" class="btn btn-primary submit_addtask pull-right" value=" Simpan">
<?php } ?>
                            </div>
                        </div>
                ...
                <div class="row">
                    <form role="form"  id="addevent_form" method="post" enctype="multipart/form-data" action="">
                        ...
                        <?php if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_add')) { ?>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <input type="submit" class="btn btn-primary submit_addevent pull-right" value=" Simpan"></div>
<?php } ?>
                    </form>
                </div>
                ...
                <div class="row">
                    <form role="form"   method="post" id="updateevent_form"  enctype="multipart/form-data" action="" >
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
                            ...
                            if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_edit')) {
                                ?>
                                <input type="submit" class="btn btn-primary submit_update pull-right" value=" Simpan">
                            <?php } ?>
                        </div>
...
<script>
    ...
    function add_task() {
        ...
        $('#newTask').modal('show');
        $('#task-date').datepicker({autoclose: true,format: 'dd-mm-yyyy'});
    ...
    function edit_todo_task(eventid) {
        ...
        $.ajax({
            ...
            success: function (res)
            {
                ...
                $("#taskid").val(eventid);
                $("#task-date").val(new Date(res.start_date).toString("dd/MM/yyyy"));
                $('#task-date').datepicker({autoclose: true,format: 'dd-mm-yyyy'});
                $('#newTask').modal('show');
                $('#permission').html('<?php if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_edit')) { ?><input type="submit" class="btn btn-primary submit_addtask pull-right" value=" Simpan"><?php } ?>');
