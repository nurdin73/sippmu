        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>laporan/penerimaan"><?php echo $title; ?></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <form action="<?php echo site_url('laporan/penerimaan') ?>"  name="search_form" method="post" accept-charset="utf-8">
                    <div class="box-body">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive box-report">
                    <section id="print_area" class="print_area">
                        ...
                        <div class="report-title2">LAPORAN PENERIMAAN KAS</div>
...
<div id="divPrintView"  class="modal fade" role="dialog">
