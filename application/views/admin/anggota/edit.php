        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('anggota') ?>">Manajemen Anggota</a></li>
                ...
                <div class="box box-primary" <?php
                    ...
                    <div class="box-body">
                        <div class="d-flex flex-column justify-content-center align-items-center">
                            ...
                            ?>
                            <img src="<?= base_url("uploads/user_images/$file") ?>" alt="" class="img-circle img-fluid img-responsive">
                            <h3><?= $user['name'] ?></h3>
                            <div class="border p-3 w-100 rounded">
                                ...
                                <div class="d-flex mt-3 justify-content-between align-items-center">
                                    ...
                                    <span class="text-primary"><?= isset($user['email']) && $user['email'] != '' ? $user['email'] : 'N/A' ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box w-100" style="border-top: 0;">
                    ...
                    <div class="box-body tab-content">
                        <div class="tab-pane active" role="tabpanel" id="profile">
                            <form action="<?= base_url('anggota/update/') . encrypt_url($user['id']) ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nbm" value="<?= $user['nbm'] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gender" class="form-control">
                                        ...
                                        ?>
                                            <option value="<?php echo $key; ?>" <?php if ($user['gender'] == $key) echo "selected"; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="address" cols="30" rows="3" class="form-control"><?= $user['address'] ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="note">Note</label>
                                    <textarea name="note" cols="30" rows="3" class="form-control"><?= $user['note'] ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="image">Pilih Foto (Maksimal 2MB)</label>
                                    <input type="file" name="image" accept="image/*">
                                </div>
                                <a href="<?= base_url('anggota/edit/') . $user['id'] ?>" class="btn btn-outline-primary" style="width: 150px;">
                                    Reset
                                </a>
                        ...
                        <div class="tab-pane" role="tabpanel" id="password">
                            <form action="<?= base_url('anggota/update_password/') . encrypt_url($user['id']) ?>" method="post">
                                <div class="form-group">
                        ...
                        <div class="tab-pane" role="tabpanel" id="permission">
                            <form action="<?= base_url('anggota/permission_app/') . encrypt_url($user['id']) ?>" method="post">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        ?>
                                            <li class="d-flex justify-content-between w-100 my-4">
                                                <label for="app[]" class="font-weight-bold"><?= $app['client_name'] ?></label>
                                                <input <?= count($checkPermission) > 0 ? "checked='true'" : '' ?> type="checkbox" name="app[]" value="<?= $app['client_id'] ?>" />
                                            </li>
                                        <?php } ?>
                                    </ul>
                                    <a href="<?= base_url('anggota/edit/') . $user['id'] ?>" class="btn btn-outline-primary" style="width: 150px;">
