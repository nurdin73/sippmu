        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>laporan/arus_kas"><?php echo $title; ?></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <form action="<?php echo site_url('laporan/arus_kas') ?>"  name="search_form" method="post" accept-charset="utf-8">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-md-2">
                                <div class="form-group">
                                    <label for="src_bulan">Periode </label>
                                    <input name="src_periode" id="src_periode" class="form-control" value="">
                                </div>
                            </div> -->
                ...
                <div class="table-responsive box-report col-md-10">
                    <section id="print_area" class="print_area">
                        <div class="report-title">
                            ...
                            <div class="report-title2">LAPORAN ARUS KAS</div>
...
$(document).ready(function () {
    ...
    // $('#src_periode').on('apply.daterangepicker', function(ev, picker) {
