                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <form action="<?php echo site_url('admin/user/edit/' . $id) ?>" id="employeeform"
                                name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                <div class="box-body">

                                    <div class="tshadow mb25 bozero">

                                        <h4 class="pagetitleh2"><?php echo $this->lang->line('basic_information'); ?>
                                        </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo $this->lang->line('username'); ?></label><br>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo $this->lang->line('password'); ?></label><small
                                                            class="req"> *</small>
                                                        <input autofocus="" id="password" name="password" placeholder=""
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo $this->lang->line('full_name'); ?></label><small
                                                            class="req"> *</small>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="cabang" name="cabang" placeholder="" type="text"
                                                            class="form-control">
                                                        ...
                                                        <span
                                                            class="text-danger"><?php echo form_error('cabang'); ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo $this->lang->line('role'); ?></label>
                                                        ...
                                                        <span
                                                            class="text-danger"><?php echo form_error('role'); ?></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="mobileno" name="phone" placeholder="" type="text"
                                                            class="form-control" value="<?php echo $user["phone"] ?>" />
                                                        <input id="editid" name="editid" placeholder="" type="hidden"
                                                            class="form-control" value="<?php echo $user["id"]; ?>" />
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo $this->lang->line('email'); ?></label><small
                                                            class="req"> *</small>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <div><textarea name="note"
                                                                class="form-control"><?php echo $user["note"] ?></textarea>
                                                        </div>
                                                        <span class="text-danger"></span>
                                                    </div>
                                                </div>
