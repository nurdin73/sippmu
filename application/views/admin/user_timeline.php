        ...
        foreach ($result as $key => $value) {
            ...
            <li class="time-label">
                <span class="bg-blue">    <?php
                    echo date($this->customlib->getAppDateFormat(), $this->customlib->dateyyyymmddTodateformat($value['timeline_date']));
                    ?></span>
            </li> 
            <li>
                <i class="fa fa-list-alt bg-blue"></i>
                <div class="timeline-item">
                    <?php if ($this->rbac->hasPrivilege('user_timeline', 'can_delete')) { ?>
                    ...
                    <div class="timeline-body">
                        <?php if (!empty($value["document"]) && ($value['doc_type'] == 'image/png' || $value['doc_type'] == 'image/jpeg')) { ?> 
                            <img class=" img-responsive " src="<?php echo base_url() . "uploads/user_timeline/" . $value["document"]; ?>" alt="">
                        <?php } ?>
