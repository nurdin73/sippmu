        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>master/mapping_posisi_keuangan"><?php echo $title; ?></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="xright xright">
                    <?php if ($this->rbac->hasPrivilege('mapping_posisi_keuangan', 'can_add')) { ?>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <div class="modal-body pt0 pb0">
                ...
                <form id="formadd" action="<?php echo site_url('master/mapping_posisi_keuangan/add') ?>" name="form-report_posisi_keuangan" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="is_posisi">Posisi</label><small class="req"> *</small>
                                    <select name="is_posisi" class="form-control" >
                                        <option value="">- Pilih -</option>
                                        <option value="L"> Left</option>
                                        <option value="R"> Right</option>
                                    </select>
                                    <span class="text-danger"><?php echo form_error('is_posisi'); ?></span>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="is_sub_total">Sub Total</label><br>
                                    <input name="is_sub_total" value="1" placeholder="" type="checkbox"   />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="is_space_after">Space After</label><br>
                                    <input name="is_space_after" value="1" placeholder="" type="checkbox"   />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            ...
            <div class="modal-body pt0 pb0">
                ...
                <form id="formedit" action="<?php echo site_url('master/mapping_posisi_keuangan/edit') ?>" role="form" name="form-posisi_keuangan" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="is_posisi">Posisi</label><small class="req"> *</small>
                                    <select id="is_posisi" name="is_posisi" class="form-control" >
                                        <option value="">- Pilih -</option>
                                        <option value="L"> Left</option>
                                        <option value="R"> Right</option>
                                    </select>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label style="display: inline-block">
                                        <input id="is_sub_total" name="is_sub_total" value="1" style="vertical-align: middle"  type="checkbox" />
                                        <span style="vertical-align: middle"> Sub Total</span>
                                    </label>
                                    <label style="display: inline-block">
                                        <input id="is_space_after" name="is_space_after" value="1" style="vertical-align: middle"  type="checkbox" />
                                        <span style="vertical-align: middle"> Space After</span>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label style="display: inline-block">
                                        <input id="is_show_detail" name="is_show_detail" value="1" style="vertical-align: middle"  type="checkbox" />
                                        <span style="vertical-align: middle"> Show Detail</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        <input type="hidden" id="posisi_keuangan_id" name="posisi_keuangan_id" value="" />
    ...
    <div class="modal-dialog modal-mid">
        <div class="modal-content modal-media-content">
            ...
            <div class="modal-body pt0 pb0">
                ...
                <form id="form_detail" action="<?php echo site_url('master/mapping_posisi_keuangan/do_detail') ?>" name="form-area" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <input type="hidden" id="posisi_keuangan_det_id" name="posisi_keuangan_det_id" value="" />
                        <input type="hidden" id="posisi_keuangan_id_detail" name="posisi_keuangan_id" value="" />
...
$(document).ready(function (e) {
    ...
    var oTable = $("#dt_table").dataTable({
        ...
        serverSide: true,
        ajax: {
            "url": base_urlx + 'master/mapping_posisi_keuangan/get_ajax', 
            "type": "POST"
        },
        columns: [
            {"data": "nomor"},
    ...
    $('#parentid').on('select2:select', function (e) {
        ...
        $.ajax({
            dataType: 'json',
            url: base_urlx + 'master/mapping_posisi_keuangan/get_kode_parent/' + value,
            ...
            success: function (data) {
                ...
                if (data.status == "fail") {
                    ...
                    if(data.levelx == 3){
                        ...
                        if(data.levelx == 3){
                            //show popup detail
                            getDetail(data.posisi_keuangan_idx);
                        }else{
    ...
    var oTableDet = $("#dt_table_detail").dataTable({
        ...
        serverSide: true,
        ajax: {
            "url": base_urlx + 'master/mapping_posisi_keuangan/get_ajax_detail', 
            "type": "POST",
            "data": function ( d ) {
                d.posisi_keuangan_id = $('#posisi_keuangan_id').val();
            }
        },
        columns: [
            {"data": "nomor", width: "5%"},
    ...
    $('#is_show_detail').change(function() {
        if ($(this).is(':checked')) {
            $('#table_detail').show();
            $('#add_detail').show();
            //reload table detail
...
function getEdit(event) {
    ...
    $.ajax({
        dataType: 'json',
        url: base_urlx + 'master/mapping_posisi_keuangan/get_data/' + id,
        success: function (result) {
            
            $('#posisi_keuangan_id').val($.trim(result.id));
            ...
            $('#is_posisi').val($.trim(result.is_posisi));
            ...
            if(result.is_show_detail == '1'){
                $('#is_show_detail').prop('checked',true);
            }else{
                $('#is_show_detail').prop('checked',false);
            }

            $("#parent").val($.trim(result.parent));
            $("#parent").trigger("change");

            if(result.level == 3 || result.is_show_detail == 1){
                $('#table_detail').show();
                $('#add_detail').show();
                //reload table detail
                $("#dt_table_detail").dataTable().api().ajax.reload();
...
function getAddDetail() {
    var posisi_keuangan_id = $("#posisi_keuangan_id").val();

    $('#myModalDetail').modal('show');
    $("#myModalDetail_title").html("Tambah Detail");
    
    $('#act_detail').val('add');
    $('#posisi_keuangan_det_id').val('');
    $('#posisi_keuangan_id_detail').val($.trim(posisi_keuangan_id));
...
function getEditDetail(event) {
    ...
    $.ajax({
        dataType: 'json',
        url: base_urlx + 'master/mapping_posisi_keuangan/get_data_detail/' + id,
        success: function (result) {
            
            $('#act_detail').val('edit');
            $('#posisi_keuangan_det_id').val($.trim(result.id));
            $('#posisi_keuangan_id_detail').val($.trim(result.report_posisi_keuangan));
...
function deleteData(event) {
    ...
    if(id){
        delete_recordById(base_urlx + 'master/mapping_posisi_keuangan/delete/' + id, nama);
    }
}
...
function deleteDataDetail(event) {
    let id = $(event).data("id").toString().trim();
    let nama = $(event).data("nama").toString().trim();
    let posisi_keuangan_id = $("#posisi_keuangan_id").val();
   
    if(posisi_keuangan_id){
        //delete_recordById(base_urlx + 'master/mapping_posisi_keuangan/deleteDetail/' + id + '/' + posisi_keuangan_id, nama, 'no');
        var url = base_urlx + 'master/mapping_posisi_keuangan/deleteDetail/' + id + '/' + posisi_keuangan_id;
        Swal.fire({
              title: 'Peringatan!',
