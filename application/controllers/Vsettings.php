...
class Vsettings extends Admin_Controller {
    ...
    function index() {
        ...
        $this->session->set_userdata('sub_menu', 'vsettings/index');
    ...
    function ajax_editlogo() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (isset($_FILES["file"]) && !empty($_FILES['file']['name'])) {
                ...
                move_uploaded_file($_FILES["file"]["tmp_name"], "./uploads/app_content/logo/" . $img_name);
            }
            ...
            $data_record = array('id' => $id, 'image' => $img_name);
             ...
             if (isset($_FILES["file"]) && !empty($_FILES['file']['name'])) {
                $fileInfo = pathinfo($_FILES["file"]["name"]);
                $img_name = $id . '.' . $fileInfo['extension'];
                move_uploaded_file($_FILES["file"]["tmp_name"], "./uploads/app_content/logo/app_logo/" . $img_name);
            }
    ...
    function ajax_schedit() {
       ...
       // print_r($_FILES['mobile_app_logo']);die;
        ...
        if ($this->form_validation->run() == false) {
            ...
            //  if (isset($_FILES["file"]) && !empty($_FILES['file']['name'])) {
            //     $fileInfo = pathinfo($_FILES["file"]["name"]);
            //     $img_edit = "uploads/app_content/logo/app_log/".$id . '.' . $fileInfo['extension'];
            //     $img_name = $id . '.' . $fileInfo['extension'];
            //     move_uploaded_file($_FILES["file"]["tmp_name"], "./uploads/app_content/logo/app_log" . $img_name);
