            ...
            <div class="col-md-12">            
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li><a href="#tab_user" data-toggle="tab"><?php echo $this->lang->line('user') ?></a></li>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($userlogList)) {
                                        ...
                                        foreach ($userlogList as $userlog) {
                                            ?>
                                            <tr>
                                                <td><?php echo $userlog['users']; ?></td>                                                
                                                <td><?php echo ucfirst($userlog['roles']); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    echo date($this->customlib->getAppDateFormat(), $this->customlib->dateyyyymmddTodateformat($date)) . " " . $time;
                                                    ?>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($userlogStaffList)) {
                                        ...
                                        foreach ($userlogStaffList as $userlogAdmin) {
                                            ?>
                                            <tr>
                                                <td><?php echo $userlogAdmin['users']; ?></td>                                                
                                                <td><?php echo ucfirst($userlogAdmin['roles']); ?></td>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($userlogStudentList)) {
                                        ...
                                        foreach ($userlogStudentList as $userlogStudent) {
                                            ?>
                                            <tr>
                                                <td><?php echo $userlogStudent['users']; ?></td>                                                
                                                <td><?php echo ucfirst($userlogStudent['roles']); ?></td>
