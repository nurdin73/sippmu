                    <ul class="nav pcoded-inner-navbar ">
                        ...
                        if ($this->module_lib->hasActive('dashboard')) {
                            if ($this->rbac->hasPrivilege('dashboard', 'can_view') ) {
                                ?>
                        <li class="nav-item <?php echo set_Topmenu('dashboard'); ?>"><a
                                href="<?php echo base_url(); ?>dashboard" class="nav-link "><span
                        ...
                        if ($this->module_lib->hasActive('sdm')) {
                            if ($this->rbac->hasPrivilege('sdm', 'can_view') ) {
                                ?>
                        <li class="nav-item <?php echo set_Topmenu('sdm'); ?>"><a href="<?php echo base_url(); ?>sdm"
                                class="nav-link "><span class="pcoded-micon"><i
                                        class="feather icon-user"></i></span><span class="pcoded-mtext">SDM</span></a>
                        </li>
                        ...
                        if ($this->module_lib->hasActive('profile')) {
                            if ($this->rbac->hasPrivilege('profile', 'can_view') ) {
                                ?>
                        <li class="nav-item <?php echo set_Topmenu('profile'); ?>"><a
                                href="<?php echo base_url(); ?>profile" class="nav-link "><span class="pcoded-micon"><i
                        ...
                        if ($this->module_lib->hasActive('transaksi_kasir')) {
                            if ($this->rbac->hasPrivilege('trx_penerimaan', 'can_view') || $this->rbac->hasPrivilege('trx_pengeluaran', 'can_view') || 
                        ...
                        if ($this->module_lib->hasActive('transaksi_akuntansi')) {
                            if ($this->rbac->hasPrivilege('trx_saldo_awal', 'can_view') || $this->rbac->hasPrivilege('trx_mutasi_jurnal', 'can_view') || 
                        ...
                        if ($this->module_lib->hasActive('laporan_kas_bank')) {
                            if ($this->rbac->hasPrivilege('report_mutasi_kas_bank', 'can_view') || $this->rbac->hasPrivilege('posisi_saldo_kas_bank', 'can_view') 
                               ) {
                                ?>
                        ...
                        if ($this->module_lib->hasActive('laporan_akuntansi')) {
                            if ($this->rbac->hasPrivilege('report_buku_besar', 'can_view') || $this->rbac->hasPrivilege('report_neraca_saldo', 'can_view') ||
                        ...
                        if ($this->module_lib->hasActive('master_akuntansi') || $this->module_lib->hasActive('master_buku_kas')) {
                            if ($this->rbac->hasPrivilege('master_kel_akun', 'can_view') || $this->rbac->hasPrivilege('master_akun', 'can_view') || 
                        ...
                        if ($this->module_lib->hasActive('master_data')) {
                            if ($this->rbac->hasPrivilege('master_cabang', 'can_view') || $this->rbac->hasPrivilege('master_cabang_klasifikasi', 'can_view') || 
                                $this->rbac->hasPrivilege('master_program', 'can_view')
                               ) {
                                ?>
                        <li class="nav-item pcoded-hasmenu <?php echo set_Topmenu('master_data'); ?>">
                            <a href="#!" class="nav-link "><span class="pcoded-micon"><i
                                        class="feather icon-cpu"></i></span><span class="pcoded-mtext">Master
                                    Data</span></a>
                            <ul class="pcoded-submenu">
                                <?php
                                        if ($this->rbac->hasPrivilege('master_cabang_klasifikasi', 'can_view')) {
                                            ?>
                                <li class="<?php echo set_Submenu('master/cabang_klasifikasi'); ?>"><a
                                        href="<?php echo base_url(); ?>master/cabang_klasifikasi"> Group Unit</a></li>

                                <?php
                                        }
                                        if ($this->rbac->hasPrivilege('master_cabang', 'can_view')) {
                                            ?>
                                <li class="<?php echo set_Submenu('master/cabang'); ?>"><a
                                        href="<?php echo base_url(); ?>master/cabang"> Unit Kerja</a></li>
                                ...
                                <?php
                                        ...
                                        if ($this->rbac->hasPrivilege('master_jabatan', 'can_view')) {
                                            ?>
                                <li class="<?php echo set_Submenu('master/jabatan'); ?>"><a
                                        href="<?php echo base_url(); ?>master/jabatan"> Jabatan</a></li>
                                ...
                                <?php
                                        ...
                                        if ($this->rbac->hasPrivilege('master_periode', 'can_view')) {
                                            ?>
                                <li class="<?php echo set_Submenu('master/periode'); ?>"><a
                                        href="<?php echo base_url(); ?>master/periode"> Periode</a></li>
                        ...
                        <li class="nav-item pcoded-hasmenu <?php echo set_Topmenu('HR'); ?>">
                            <a href="#!" class="nav-link "><span class="pcoded-micon"><i
                                        class="feather icon-user"></i></span><span class="pcoded-mtext">Manajemen
                                    User</span></a>
                            <ul class="pcoded-submenu">
                                <?php if ($this->rbac->hasPrivilege('user', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('admin/user'); ?>"><a
