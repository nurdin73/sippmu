                    <ul class="nav pcoded-inner-navbar ">
                        ...
                        <?php
                                ...
                                if ($this->module_lib->hasActive('management_keanggotaan')) {
                                        if ($this->rbac->hasPrivilege('management_keanggotaan', 'can_view')) {
                                        ?>
                        <li class="nav-item <?php echo set_Topmenu('anggota'); ?>"><a
                                href="<?php echo base_url(); ?>anggota" class="nav-link "><span class="pcoded-micon"><i
                                        class="feather icon-users"></i></span><span class="pcoded-mtext">Management
                                    Anggota</span></a></li>
                        ...
                        <?php
                                ...
                                if ($this->module_lib->hasActive('management_asset')) {
                                        if ($this->rbac->hasPrivilege('management_asset', 'can_view')) {
                                        ?>
                        <li class="nav-item <?php echo set_Topmenu('asset'); ?>"><a
                                href="<?php echo base_url(); ?>asset" class="nav-link "><span class="pcoded-micon"><i
                                        class="feather icon-clipboard"></i></span><span class="pcoded-mtext">Management
                                    Asset</span></a></li>
                        ...
                        <li class="nav-item pcoded-hasmenu <?php echo set_Topmenu('master_data'); ?>">
                            ...
                            <ul class="pcoded-submenu">
                                ...
                                <?php
                                                                ...
                                                                ?>
                                <li class="<?php echo set_Submenu('master/clients'); ?>"><a
                                        href="<?php echo base_url(); ?>master/clients"> Clients</a></li>
                                <?php
                                                                }
                                                                ?>
                            </ul>
