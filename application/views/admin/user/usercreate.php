                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <form action="<?php echo site_url('admin/user/create') ?>" id="employeeform"
                                    ...
                                    <div class="tshadow mb25 bozero">
                                        ...
                                        <div class="around10">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo $this->lang->line('username'); ?></label><small
                                                            class="req"> *</small>
                                                        <input autofocus="" id="username" name="username" placeholder=""
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Unit Kerja</label><small
                                                            class="req"> *</small>
                                                        <select id="cabang" name="cabang" placeholder="" type="text"
                                                            ...
                                                            <option value="<?php echo $value["id"] ?>"
                                                                <?php echo set_select('cabang', $value['id'], set_value('cabang')); ?>>
                                                                <?php echo $value["kode"] ?> -
...
$(document).ready(function() {
    var date_format =
        '<?php echo $result = strtr($this->customlib->getAppDateFormat(), ['d' => 'dd', 'm' => 'mm', 'Y' => 'yyyy',]) ?>';
    $('#dob').datepicker({
        format: date_format,
        autoclose: true
    });
