        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>laporan/pengeluaran"><?php echo $title; ?></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <form action="<?php echo site_url('laporan/pengeluaran') ?>"  name="search_form" method="post" accept-charset="utf-8">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <!--<div class="col-md-1">
                                <div class="form-group">
                                    <label> &nbsp; &nbsp; &nbsp; </label>
                                    <a href="#" onclick="getPrintView()"  role="button" class="btn btn-primary btn-sm checkbox-toggle edit_setting" data-toggle="tooltip" title="Preview" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-print"></i> Preview</a>
                                </div>
                            </div>-->
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive box-report">
                    <section id="print_area" class="print_area">
                        ...
                        <div class="report-title2">LAPORAN PENGELUARAN KAS</div>
                        ...
                        <table class="table-report">
                            ...
                            <tbody>
                                ...
                                if($data_pengeluaran){
                                    $total_rows = $data_pengeluaran['total'];
                                    $subtotal = array();
                                    $no_transaksi_array = array();
                                    $no_transaksi_before = '';
                                    $total_all = 0;
                                    $no = 1;
                                    foreach($data_pengeluaran['result'] as $row){
