    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('asset/insert') ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?= set_value('wakif_perolehan') ?>" name="wakif_perolehan" id="wakif_perolehan" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="legalitas_bhn">Legalitas Bukti Hak Nomor</label>
                    <input type="text" name="legalitas_bhn" value="<?= set_value('legalitas_bhn') ?>" id="legalitas_bhn" class="form-control">
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pendayagunaan">Pendayagunaan</label>
                            <input type="text" value="<?= set_value('pendayagunaan') ?>" id="pendayagunaan" name="pendayagunaan" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="nilai_njop" id="nilai_njop" value="<?= set_value('nilai_njop') ?>" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nilai_bangunan">Nilai Bangunan</label>
                            <input type="number" value="<?= set_value('nilai_bangunan') ?>" id="nilai_bangunan" name="nilai_bangunan" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="alamat" cols="30" rows="3" class="form-control">value="<?= set_value('alamat') ?>"</textarea>
            </div>
